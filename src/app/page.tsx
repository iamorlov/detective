    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-black via-slate-900 to-gray-900 flex items-center justify-center p-4 sm:p-8 relative overflow-hidden">
        ...
        <div className="max-w-md sm:max-w-2xl lg:max-w-3xl w-full relative z-10">
          ...
          {/* CTA Button */}
          <div className="text-center animate-slide-up-delayed-3 px-4 flex flex-col items-center gap-6">
            {isAuthenticated ? (
              <>
                ...
                {hasSavedGame && (
                  <div className="w-full max-w-sm animate-slide-up-delayed-4">
                    ...
                    >
                      ...
                      <span className="relative z-10 drop-shadow-lg playfair-font">{t.continueGame}</span>
                    </button>
                  </div>
                )}
              ...
              <div className="w-full max-w-sm">
                ...
                >
                  ...
                  <span className="drop-shadow-lg">{signingIn ? t.singingIn : t.continueWithGoogle}</span>
                </button>
              </div>
            )}
          </div>
